...
class AirfoilDataset(Dataset):
    ...
    def __init__(self, airfoils, n_points=200):
        ...
        print(f"✅ Dataset created: {len(self.data)} valid airfoils")
        print(f"❌ Failed to process: {failed_count} airfoils")
        if len(self.data) > 0:
...
def main():
    ...
    print("   ✅ Saved visualization to outputs/plots/dataset_samples.png")
